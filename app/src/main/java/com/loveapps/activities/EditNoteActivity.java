...
public class EditNoteActivity extends AppCompatActivity {
    ...
    private static final int editNoteActReqCode = 2;
    private DAO dao;
    ...
    public void viewNotes(View view) {
        ...
        getNoteScreenIntent.putExtra(DAO.CONTENT_ITEM_TYPE, noteEdit.getId());
        startActivityForResult(getNoteScreenIntent, editNoteActReqCode);
